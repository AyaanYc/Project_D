<?php
    ...
    function sel_board(&$param) {
        ...
        $sql = "SELECT B.profile_img, B.nm, A.created_at
                    , A.food_img, A.food_url, A.food_ctnt
                  FROM f_board A
                 INNER JOIN t_user B
                    ON A.user_no = B.user_no
    ...
    {     
        $sql = "SELECT A.food_no, A.food_img, A.food_title, A.created_at,B.profile_img, B.nm 
                FROM f_board A
